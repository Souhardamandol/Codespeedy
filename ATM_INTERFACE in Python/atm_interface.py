...
# Create the labels
label_1 = tk.Label(root, text="Welcome to the ATM", font='Roboto 18 bold', bg="coral")


label_2 = tk.Label(root, text="Please select an option", font = "11", bg="magenta")
label_3 = tk.Label(root, text="Enter the amount", font = 'Helvetica 13 bold', bg="violet")
...
button_3 = tk.Button(root, text="Check Balance", bg="pink", fg="black",font = "8")
button_4 = tk.Button(root, text="Exit", bg="cyan", fg="black",font = "8", width="12")
button_5 = tk.Button(root, text="Clear", bg="red", fg="white",font = "8", width="12")
